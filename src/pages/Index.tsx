    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-6">
      <div className="flex flex-col items-center text-center max-w-lg">
        ...
        <p className="text-lg md:text-xl text-muted-foreground mb-6 leading-relaxed">
          You have not paid for the <span className="text-primary font-medium">LogViewer</span> plan.
        </p>
        
        <p className="text-muted-foreground mb-8">
          Logs are sent in a logs channel as a <code className="bg-secondary px-2 py-1 rounded text-primary font-mono text-sm">.txt</code> file.
        </p>
